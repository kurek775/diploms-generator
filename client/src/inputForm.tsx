...
const InputForm = () => {
    ...
    const [excelValues, setExcelValues] = useState<Object>(null);
    ...
    return (
        <Card>
            ...
            {generated  ?
                <PDFDownloadLink className="btn btn-primary" document={<MyDocument objects={excelValues} />} fileName="example.pdf">
